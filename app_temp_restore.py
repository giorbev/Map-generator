...
if st.session_state.base_map is None:
    ...
    # Onglets principaux
    tab_terrain, tab_satmap, tab_gen, tab_validation, tab_ttile, tab_correction, tab_pipeline = st.tabs([
        " Terrain",
        "🛰️ Satmap Export",
        " Génération",
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    # ONGLET TERRAIN BINAIRE — Grille QTRE 32×32
    # ═══════════════════════════════════════════════════════════════════════════
...
"""
    ...
    # ========================================================================
    # ONGLET CORRECTION TERRAIN — Clean Weights
    # ========================================================================

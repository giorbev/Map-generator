"""
Analyse QTRE sur masks optimisés Zimnitrita
"""
...
# Dossier masks optimisés
masks_dir = Path(r"h:\logiciel perso\Map generator\data\projects\Zimnitrita\pipeline_11masks_optimized_20260611_174609")
output_dir = masks_dir
cellsize = 4.0

print("="*80)
print("ANALYSE QTRE - Version Optimisee")
print("="*80)
print(f"\nMasks: {masks_dir}")
...
if results:
    ...
    # Chercher dirt_erosion dans texture_distribution si disponible
    print("\n" + "="*80)
else:

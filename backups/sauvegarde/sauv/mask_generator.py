...
EXCLUSION_MASK = Path(r"H:\logiciel perso\Map generator\masque_exclusion.png")
...
# ============================================================================
GAEA_MASKS = [
    (Path(r"H:\logiciel perso\Map generator\export\03_mask_flow.png"),    "mask_flow"),
    (Path(r"H:\logiciel perso\Map generator\export\02_mask_deposit.png"), "mask_deposit"),
...
def generate_slope_masks(slope: np.ndarray, t: dict,
    ...
    landes[m_fall] = 1.0 - (slope[m_fall] - t['rock']) / TRANSITION_WIDTH

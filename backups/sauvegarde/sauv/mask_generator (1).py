...
EXCLUSION_MASK = Path(r"H:\logiciel perso\Map generator\data\projects\Zimnitrita\masks\masque_exclusion.png")
...
# ============================================================================
GAEA_MASKS = [
    (Path(r"H:\logiciel perso\Map generator\data\projects\Zimnitrita\masks\03_mask_flow.png"),    "mask_flow",    0.5),
    (Path(r"H:\logiciel perso\Map generator\data\projects\Zimnitrita\masks\02_mask_deposit.png"), "mask_deposit", 1.0),
]
